...
Original file is located at
    https://colab.research.google.com/drive/1jSHHAdXX5x0VbwRY9SUsO4vUiduO94tI
"""
...
train, val = train_test_split(train, test_size=0.05, random_state=902203)
...
y1_output = Dense(units=1, activation='linear', name='numerical')(n3)
...
def customLoss(y_true,y_pred):
    return abs(((K.sqrt(y_true + 0.0001)) - (K.sqrt(y_pred + 0.0001))))/(y_true + 0.002)
...
print(df.shape)
df.to_excel('pixel50f3.xlsx')
!cp pixel50f3.xlsx "drive/My Drive/"